...
public:
	...
	static void marginAdjustedlayout(int topMargin, int bottomMargin, ComponentPtr comp, ComponentPtr prev, int idx, int size, int px, int py, int pw, int ph);
	/** Standard menu layout, stacks menu items vertically, equally spaced */
	static void layoutFunction(ComponentPtr comp, ComponentPtr prev, int idx, int size, int px, int py, int pw, int ph);

	/** Standard menu layout, stacks menu items vertically in two columns */
	static void twoColumnLayoutFunction(ComponentPtr comp, ComponentPtr prev, int idx, int size, int px, int py, int pw, int ph);
};
