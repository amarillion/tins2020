...
class Label : public Widget {
   protected:
	//TODO: we need unicode support. Perhaps this is better modeled as
	// something from boost::locale
	// or a wrapper for ALLEGRO_USTR
      std::string text;
      int alignment;
        int valignment;
        bool wordwrap;
   ...
   protected:
      ...
      */
      virtual void MsgInitSkin() override;
      /**
