...
//	}
	...
	void drawSurfaceWire (const GraphicsContext &gc, int mx, int my, int mz, int mxs, int mys, ALLEGRO_COLOR color) const;
	void drawLeftWire (const GraphicsContext &gc, int mx, int my, int mz, int mxs, int mys, ALLEGRO_COLOR color) const;
	void drawRightWire (const GraphicsContext &gc, int mx, int my, int mz, int mxs, int mys, ALLEGRO_COLOR color) const;
	void drawWireFrame (const GraphicsContext &gc, int mx, int my, int mz, int sx, int sy, int sz, ALLEGRO_COLOR color) const;
